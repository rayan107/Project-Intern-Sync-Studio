...
<body>
    <div class="result-card">
        @if(isset($success) && $success)
            ...
            <p class="message">{{ $user->name ?? 'User' }} has been successfully checked in.</p>
            ...
            <div class="event-details">
                ...
                <div class="detail-row">
                    ...
                    <span><strong>{{ $event->title ?? 'N/A' }}</strong></span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span>
                        ...
                        <small style="color: #888;">({{ $user->email ?? 'N/A' }})</small>
                    </span>
                </div>
            ...
            {{-- Check-in Time outside event-details for better visibility --}}
        ...
        @else
            ...
            <p class="message">{{ $message ?? 'Unable to verify check-in' }}</p>
