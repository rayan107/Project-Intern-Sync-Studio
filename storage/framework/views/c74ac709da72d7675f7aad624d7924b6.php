...
<div class="wrap">
  <div class="hero-strip">
    ...
    <div style="display:flex;justify-content:center;">
      <div class="stats-bar">
        <div class="stat-item"><div class="stat-num" id="totalEventsCount"><?php echo e(count($events)); ?></div><div class="stat-lbl">Total Events</div></div>
        <div class="stat-item"><div class="stat-num" id="freeEventsCount"><?php echo e($events->where('price', 0)->count()); ?></div><div class="stat-lbl">Free Events</div></div>
        <div class="stat-item"><div class="stat-num" id="paidEventsCount"><?php echo e($events->where('price', '>', 0)->count()); ?></div><div class="stat-lbl">Paid Events</div></div>
  ...
  <div class="events-grid" id="eventsGrid">
    ...
    ?>
    <div class="event-card <?php echo e($isFinished ? 'finished' : ''); ?>" data-id="<?php echo e($event->id); ?>" data-title="<?php echo e(strtolower($event->title)); ?>" data-full-title="<?php echo e($event->title); ?>" data-description="<?php echo e($event->description); ?>" data-location="<?php echo e($event->location); ?>" data-date="<?php echo e($event->event_date); ?>" data-start-time="<?php echo e($event->start_time); ?>" data-end-time="<?php echo e($event->end_time); ?>" data-price="<?php echo e($event->price); ?>" data-attendees="<?php echo e($event->users_count ?? 0); ?>" data-tab-free="<?php echo e($event->price == 0 ? 'true' : 'false'); ?>" data-tab-paid="<?php echo e($event->price > 0 ? 'true' : 'false'); ?>" data-images='<?php echo json_encode($event->images->map(fn($img) => asset("storage/".$img->image_path)), 15, 512) ?>' data-category="<?php echo e($event->category ?? 'general'); ?>" data-lat="<?php echo e($event->latitude ?? 37.7749); ?>" data-lng="<?php echo e($event->longitude ?? -122.4194); ?>" onclick="openDetail(this)">
      <div class="card-img-wrap">
        <?php if($event->images->count()): ?> <img src="<?php echo e(asset('storage/' . $event->images->first()->image_path)); ?>" alt="<?php echo e($event->title); ?>"> <?php else: ?> <img src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800" alt="<?php echo e($event->title); ?>"> <?php endif; ?>
        <div class="price-badge price-badge-tag <?php echo e($event->price > 0 ? 'paid' : 'free'); ?>"><?php echo e($event->price > 0 ? '$'.number_format($event->price, 2) : 'FREE'); ?></div>
        <div class="reg-badge" style="display:none;" id="reg-badge-<?php echo e($event->id); ?>"><i class="bi bi-check-circle-fill"></i> Registered</div>
        <?php if($isFinished): ?>
          <div class="finished-badge"><i class="bi bi-check2-circle"></i> Finished</div>
        <?php endif; ?>
        <div class="share-modal-btn" onclick="event.stopPropagation(); shareEvent(<?php echo e($event->id); ?>, '<?php echo e(addslashes($event->title)); ?>')"><i class="bi bi-share-fill"></i></div>
        <div class="fav-badge fav-disabled" id="fav-badge-<?php echo e($event->id); ?>" onclick="event.stopPropagation(); toggleFavorite(<?php echo e($event->id); ?>)"><i class="bi bi-heart" id="fav-icon-<?php echo e($event->id); ?>"></i></div>
      </div>
      <div class="card-body">
        <div class="card-date-chip"><i class="bi bi-calendar3"></i> <?php echo e(\Carbon\Carbon::parse($event->event_date)->format('M d, Y')); ?></div>
        <h3 class="card-title"><?php echo e($event->title); ?></h3>
        <p class="card-desc"><?php echo e($event->description); ?></p>
        ...
        <div class="card-foot">
          <div class="card-stats"><div class="attendees"><i class="bi bi-people-fill"></i> <span id="attendees-count-<?php echo e($event->id); ?>"><?php echo e($event->users_count ?? 0); ?></span> attending</div>
          <div class="card-rating-mini" id="card-rating-<?php echo e($event->id); ?>" data-event-id="<?php echo e($event->id); ?>" data-event-title="<?php echo e(addslashes($event->title)); ?>"><i class="bi bi-star-fill"></i> <span id="rating-value-<?php echo e($event->id); ?>">0.0</span> <span id="rating-count-<?php echo e($event->id); ?>">(0)</span></div></div>
          <div class="card-btns-row">
            <button class="btn-cancel-reg" id="cancel-btn-<?php echo e($event->id); ?>" onclick="event.stopPropagation(); openCancelModal(<?php echo e($event->id); ?>, '<?php echo e(addslashes($event->title)); ?>')" <?php echo e($isFinished ? 'disabled style="opacity:0.5;"' : ''); ?>><i class="bi bi-x-circle"></i> Cancel</button>
            <button class="btn-reg" id="reg-btn-<?php echo e($event->id); ?>" onclick="event.stopPropagation(); handleCardRegClick(<?php echo e($event->id); ?>, '<?php echo e(addslashes($event->title)); ?>', '<?php echo e($event->event_date); ?>', '<?php echo e($event->start_time); ?>', '<?php echo e($event->end_time); ?>', '<?php echo e(addslashes($event->location)); ?>', <?php echo e($event->price); ?>)" <?php echo e($isFinished ? 'disabled style="opacity:0.5;cursor:not-allowed;"' : ''); ?>><i class="bi bi-calendar-plus"></i> Register</button>
          </div>
        </div>
      </div>
    </div>
...
</html><?php /**PATH C:\Users\User\backend\resources\views/userregistereventpage.blade.php ENDPATH**/ ?>