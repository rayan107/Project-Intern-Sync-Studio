  ...
  <div class="login-container">
    ...
    <div class="login-body">
      ...
      <div class="reset-link-box">
        ...
        <a href="<?php echo e(session('resetLink')); ?>" target="_blank">
          <?php echo e(session('resetLink')); ?>
      ...
      <form method="POST" action="<?php echo e(route('admin.password.email')); ?>" id="forgotForm">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\User\backend\resources\views/admin/auth/forgot-password.blade.php ENDPATH**/ ?>