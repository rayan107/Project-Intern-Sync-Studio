...
<body>
  ...
  <div class="login-container">
    ...
    <div class="login-body">
      ...
      <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" id="loginForm">
        <?php echo csrf_field(); ?>
        
        <div class="form-group">
          <label class="form-label" for="email"><i class="fas fa-envelope"></i> Email Address</label>
          <input type="email" id="email" name="email" class="form-control" placeholder="admin@eventhub.com" value="<?php echo e(old('email')); ?>" required autocomplete="email">
        </div>
        ...
        <a href="<?php echo e(route('admin.password.request')); ?>" class="forgot-link"><i class="fas fa-question-circle"></i> Forgot password?</a>
...
</html><?php /**PATH C:\Users\User\backend\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>